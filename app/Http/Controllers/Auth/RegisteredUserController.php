...
class RegisteredUserController extends Controller
{
    ...
    public function create()
    {
        return Inertia::render('Auth/Register', [
            ...
            'user_types' => [User::ADMIN, User::CLIENT], // Only 'admin' and 'client' types
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'user_type' => 'required|in:admin,client', // Only 'admin' and 'client' allowed
        ...
        // Assign role based on user_type (using role_id)
